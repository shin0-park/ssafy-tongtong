...
- 최상위 API 기준: `library_outing_frontend_api_contract_v2.0.md` 내부 문서 버전 v4.0
- 실행·시연 기준: `README.md`
- 페이지 구조 기준: `도서관 나들이 주요 페이지 구조.txt`
- 디자인 기준: `DESIGN.md`
- 도메인 참고: `library_outing_Django_spec_v3.md`, `library_outing_ERD_v3.md` 내부 문서 버전 v4.0
...
2. `library_outing_frontend_api_contract_v2.0.md` 내부 문서 버전 v4.0
3. `README.md`의 실행·fixture·smoke test 순서
4. `library_outing_Django_spec_v3.md`, `library_outing_ERD_v3.md` 내부 문서 버전 v4.0
5. 본 Frontend 명세 v4
6. `DESIGN.md`
7. 과거 명세와 목업
